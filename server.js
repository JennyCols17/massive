...
app.get('/fcc', (req, res) => {res.render('fcc'); });
app.get('/fic', (req, res) => {res.render('fic'); });
app.get('/hkt', (req, res) => {res.render('hkt'); });
app.get('/koito', (req, res) => {res.render('koito'); });
app.get('/kp', (req, res) => {res.render('kp'); });
app.get('/kyosan', (req, res) => {res.render('kyosan'); });
app.get('/luk', (req, res) => {res.render('luk'); });
app.get('/mitoyo', (req, res) => {res.render('mitoyo'); });
app.get('/mitsubishi', (req, res) => {res.render('mitsubishi'); });
app.get('/miyaco', (req, res) => {res.render('miyaco'); });
app.get('/musashi', (req, res) => {res.render('musashi'); });
app.get('/nichirin', (req, res) => {res.render('nichirin'); });
app.get('/nissin', (req, res) => {res.render('nissin'); });
app.get('/nok', (req, res) => {res.render('nok'); });
app.get('/npr', (req, res) => {res.render('npr'); });
app.get('/obk', (req, res) => {res.render('obk'); });
app.get('/optibelt', (req, res) => {res.render('optibelt'); });
app.get('/osaka', (req, res) => {res.render('osaka'); });
app.get('/rocky', (req, res) => {res.render('rocky'); });
app.get('/sankei', (req, res) => {res.render('sankei'); });
app.get('/sbk', (req, res) => {res.render('sbk'); });
app.get('/seco', (req, res) => {res.render('seco'); });
app.get('/shimahide', (req, res) => {res.render('shimahide'); });
app.get('/tama', (req, res) => {res.render('tama'); });
